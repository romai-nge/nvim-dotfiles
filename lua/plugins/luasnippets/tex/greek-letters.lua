...
return {}, {
	...
	s({trig = ";e", wordTrig = false}, { t("\\epsilon ") }, {condition = in_mathzone}),
	s({trig = ";z", wordTrig = false}, { t("\\zeta ") }, {condition = in_mathzone}),
	s({trig = ";h", wordTrig = false}, { t("\\eta ") }, {condition = in_mathzone}),
	s({trig = "\\tau h", wordTrig = false}, { t("\\theta ") }, {condition = in_mathzone}),
	...
	s({trig = "\\pi h", wordTrig = false}, { t("\\phi ") }, {condition = in_mathzone}),
	s({trig = ";ch", wordTrig = false}, { t("\\chi ") }, {condition = in_mathzone}),
	s({trig = "\\pi s", wordTrig = false}, { t("\\psi ") }, {condition = in_mathzone}),
	...
	s({trig = "\\Pi s", wordTrig = false}, { t("\\Psi ") }, {condition = in_mathzone}),
	s({trig = ";W", wordTrig = false}, { t("\\Omega ") }, {condition = in_mathzone}),
	s({trig = ";ve", wordTrig = false}, { t("\\varepsilon ") }, {condition = in_mathzone}),
